...
{
    return plugin::CallMethodAndReturn<CFire*, 0x0053a050, CFireManager* ,CEntity*, CEntity*, _IGNORED_ float, _IGNORED_ unsigned char, unsigned int, signed char>(this, target, creator, size, arg3, time, numGenerations);;
}
